...
### 1. Set up your points system  

<img 
  src="./images/Capture 1.png" 
  alt="Ziovy Setup Guide Screenshot" 
  width="600" 
  style={{ borderRadius: "12px", boxShadow: "0 4px 10px rgba(0,0,0,0.1)" }}
/>

Decide how customers earn and redeem points.  
- Choose earning rules (purchases, sign-ups, referrals, reviews, etc.)  
- Set redemption options (discounts, coupons, free products, etc.)  

---
title: "Introduction"
description: "Welcome to Ziovy documentation – your hub for loyalty and retention setup"
---

## Setting up

Get your Ziovy loyalty and rewards program running in just minutes
...
<Columns cols={2}>
  ...
  <Card title="Images" icon="image" href="/images/checks-passed.png">
